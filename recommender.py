...
with open(r'C:\Users\altam\Downloads\Major\recommendation.pkl', 'rb') as f:
    knn = pickle.load(f) # Load the model directly

# Load the dataset and feature scaling separately
df_cleaned = pd.read_csv(r'C:\Users\altam\Downloads\Major\spotify_dataset.csv')  # Load the dataset
